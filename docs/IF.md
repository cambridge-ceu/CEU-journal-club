...
If you do not wish to download the CSV files, please use the <a href="https://github.com/cambridge-ceu/CEU-journal-club/tree/master/docs/IF"><font color="red"><b>GitHub</b></a> to navigate to the designated file(s).
